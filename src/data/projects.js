const projects = [
  ...
  },
  {
    ...
    description:
      "A state-driven Tic Tac Toe game with predictable logic and real-time UI updates.",
    problem:
  ...
  },
  {
    ...
    description:
      "A responsive UI clone replicating Paytm’s interface using modern frontend tools.",
    problem:
