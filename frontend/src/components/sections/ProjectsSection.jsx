...
const defaultOutcomes = ["Responsive MERN app", "Reusable UI components", "Clean API integration"];
          ...
          <>
            ...
            <div className="mt-10 grid gap-4 sm:mt-12 sm:gap-6 md:grid-cols-2 xl:grid-cols-3">
              {projectItems.map((project, index) => {
                const outcomes = Array.isArray(project.outcomes) && project.outcomes.length > 0
                  ? project.outcomes
                  : defaultOutcomes;
                  ...
                  >
                    ...
                    <ul className="mt-5 grid gap-2 text-sm text-slate-700 dark:text-slate-200">
                      {outcomes.slice(0, 3).map((outcome) => (
                        <li key={outcome} className="flex gap-2 leading-6">
